...
export const Header = () => {
  ...
  return (
    <Sheet>
      <div className="fixed top-0 right-0 left-0 w-full bg-neutral-950/80 backdrop-filter backdrop-blur-md z-20">
        <div className="flex items-center w-[90%] mx-auto py-2 justify-between">
          <div className="flex gap-x-2 lg:gap-x-4 items-center">
            ...
            <p className="text-white text-md lg:text-xl font-bold">
              dev/pureawake
            </p>
          </div>
      ...
      <SheetContent 
        side={side} 
        className="pt-1 pl-0 lg:pl-1 pr-0 pb-0 lg:pt-0 border-0 m-0 bg-gradient-to-tl rounded-none from-stone-500 via-cyan-500 overflow-y-auto to-green-300 h-[440px] lg:h-screen">
        <RightPanel />
      </SheetContent>
    </Sheet>
  )
